...
function Users() {
  ...
  useEffect(() => {
    async function getData() {
      const response = await axios.get(
        "https://6320876e9f82827dcf2ede90.mockapi.io/users"
      );
  ...
  const handleDelete = async (id) => {
    const response = await axios.delete(
      `https://6320876e9f82827dcf2ede90.mockapi.io/users/${id}`
    );
    ...
    if (errKeys.length >= 1) {
      ...
      if (formData.id) {
        ...
        const response = await axios.put(
          `https://6320876e9f82827dcf2ede90.mockapi.io/users/${formData.id}`,
          {
            name: formData.name,
            age: formData.age,
